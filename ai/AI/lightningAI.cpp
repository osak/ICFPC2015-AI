...
Result LightningAI::run(){
	...
	addEvaluator(&LightningEval::calcMaster, 30);
	addEvaluator(&LightningEval::calcGod, 30);
	addEvaluator(&LightningEval::calcBuddha, 30);
	addEvaluator(&LightningEval::calcRand, 10);
